...
class EpochBuffer:
    def __init__(self, fixed_length=400):
        ...
        self.fixed_list = [0 for i in range(fixed_length)]
    ...
    def get_data(self, fixed_length, moved_length, f_m_ratio, i):
        ...
        y = self.buffer_2[b: moved_length * (1 + a) + b]
        self.fixed_list[-moved_length * (1 + a):] = y
        tmp = self.fixed_list[::-1]
        return tmp, self.sample_rate
    ...
    def get_filter_rhythm(self, l_f=4, h_f=8,):
